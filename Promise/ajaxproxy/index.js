...
var filter = function (pathname, req) {
  ...
  // multiple origin version:
   return ((req.headers.origin === 'http://www.weathertodayapi.example') || (req.headers.origin === 'https://www.weathertodayapi.example'));   
};
...
var apiOptions = {
  ...
  pathRewrite: {
    '^/openweathermap/': '/', // remove endpoint from request path ('^/api/': '/')
  },
  onProxyReq: (proxyReq) => {
    ...
    proxyReq.path += ('&appid=' + process.env.OWM_APIKEY);
  },
...
app.use('/openweathermap', apiProxy);
